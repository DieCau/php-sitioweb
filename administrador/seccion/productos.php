...
switch($accion){
  case 'Agregar':
    ...
    // Una vez ejecutada la sentencia SQL se redirecciona a productos.php
      ...
      <!-- Formulario -->
        <form method="POST" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" required readonly class="form-control" value="<?php echo $txtID; ?>" name="txtID" id="txtID" placeholder="Ingrese ID">
          </div>
          ...
          <div class="form-group">
            ...
            <?php if($txtImagen != '') { ?>
              ...
              <img class="img-thumbnail rounded" width="50" src="../../img/<?php echo $txtImagen; ?>">
  ...
  <table class="table table-bordered">
    ...
    <?php foreach($listaLibros as $libro) { ?>
      <tr>
        ...
        <img class="img-thumbnail rounded" src="../../img/<?php echo $libro['imagen']; ?>" width="50" alt="img_libro">
